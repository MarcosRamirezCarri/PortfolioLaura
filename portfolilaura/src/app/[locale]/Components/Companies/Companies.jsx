...
<h1 data-aos='fade-left' className="text-2xl lg:text-4xl flex flex-row gap-2 text-center self-center text-offSalmon-200 font-semibold font-spartan">Marcas con las que he trabajado</h1>
  </div> 
      ...
      >
        {clonedComps.map((a, index) => (
          ...
          >
            ...
            <p className='font-spartan lg:text-xl text-offSalmon-950 [text-shadow:_1px_7px_17px_rgba(0,0,0,0.77)] self-center relative'>{a.name}</p>
          </div>
        ))}

  ...
  return (
    <div className="w-full flex flex-col relative select-none ">
      ...
      <div className="flex flex-col gap-3">
        ...
        <h1
          data-aos="fade-left"
          className="text-2xl lg:text-4xl flex flex-row gap-2 text-center self-center text-offSalmon-200 font-semibold font-spartan"
        >
      ...
      >
        {clonedComps.map((a, index) => (
          <div key={index} className={style.slide}>
            <Image
              className="h-8 w-12 rounded place-self-start absolute z-[100]"
              width={50}
              height={50}
              src={a.country}
              alt="PhCompanie"
            />
            <Image
              className="h-24 w-24 rounded-xl self-center relative"
              src={a.imagen}
              alt="phProyect"
              width={100}
              height={100}
            />
            <p className="font-spartan lg:text-xl text-offSalmon-950 [text-shadow:_1px_7px_17px_rgba(0,0,0,0.77)] self-center relative">
              {a.name}
            </p>
          </div>
        ))}
